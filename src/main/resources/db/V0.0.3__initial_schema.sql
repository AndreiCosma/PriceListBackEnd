...
ALTER TABLE "app_user" ADD CONSTRAINT "app_user_fk1" FOREIGN KEY ("registration") REFERENCES "registration"("id");
...
ALTER TABLE "check_list" ADD CONSTRAINT "check_list_fk0" FOREIGN KEY ("owner_id") REFERENCES "app_user"("id");

ALTER TABLE "check_list_item" ADD CONSTRAINT "check_list_item_fk0" FOREIGN KEY ("check_list_id") REFERENCES "check_list"("id");

ALTER TABLE "check_list_link_app_user" ADD CONSTRAINT "check_list_link_app_user_fk0" FOREIGN KEY ("owner_id") REFERENCES "app_user"("id");
